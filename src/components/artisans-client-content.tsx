  ...
  const handleGoLive = () => {
    ...
    if (isRecording) {
      ...
      toast({
        ...
        description: 'Your live stream recording has been saved.',
      });
    } else {
      // Start recording
      try {
        ...
        recorder.onstop = () => {
          ...
          a.href = url;
          a.download = `live-stream-${new Date().toISOString()}.webm`;
        ...
        toast({
          ...
          description: 'Your live stream is now recording.',
        });
      } catch (error) {
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-3xl">
          ...
          <div className="flex justify-between items-center mt-4">
             ...
             <Button size="lg" onClick={handleGoLive} className="bg-red-600 hover:bg-red-700">
               {isRecording ? 'Stop Live' : 'Go Live Now'}
             </Button>
          </div>
        </DialogContent>
      </Dialog>
